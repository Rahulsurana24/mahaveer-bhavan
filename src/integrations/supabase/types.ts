...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      member_whatsapp_settings: {
        Row: {
          created_at: string | null
          id: string
          last_message_at: string | null
          member_id: string | null
          opt_in_donations: boolean | null
          opt_in_events: boolean | null
          opt_in_general: boolean | null
        ...
        Relationships: [
          {
            foreignKeyName: "member_whatsapp_settings_member_id_fkey"
            columns: ["member_id"]
            isOneToOne: true
            referencedRelation: "members"
            referencedColumns: ["id"]
