...
SELECT '' as "";
SELECT 'UPDATE user_profiles' as "SQL";
SELECT 'SET role_id = (SELECT id FROM user_roles WHERE name = ''superadmin'')' as "SQL";
SELECT 'WHERE email = ''admin@mahaveer.com'';' as "SQL";
SELECT '' as "";
SELECT '8. Verify with:' as "STEP";
SELECT 'SELECT up.email, ur.name as role FROM user_profiles up' as "SQL";
SELECT 'LEFT JOIN user_roles ur ON up.role_id = ur.id' as "SQL";
SELECT 'WHERE up.email = ''admin@mahaveer.com'';' as "SQL";
SELECT '========================================' as "DONE";
